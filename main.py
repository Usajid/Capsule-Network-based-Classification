...
def train(model, supervisor, num_label):
    trX, trY, num_tr_batch, valX, valY, num_val_batch = load_data(cfg.datasetToUse, cfg.batch_size, is_training=True)
...
def evaluation(model, supervisor, num_label):
    teX, teY, num_te_batch = load_data(cfg.datasetToUse, cfg.batch_size, is_training=False)
    fd_test_acc = save_to()
